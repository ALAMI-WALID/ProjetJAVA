 ...
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item"><a href="Listbook.jsp" class="nav-link">BOOKS</a></li>
         <li class="nav-item"><a href="login.jsp" class="nav-link">STUDENT</a></li>
     </ul>
 </div>
</div>
</nav>
...
<div class="hero-wrap js-fullheight" style="background-image: url('images/walid.jpg');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <span class="subheading">Welcome to StudyBook</span>
        <h1 class="mb-4">We Are Online Platform For Make BOOKS</h1>
        <p class="mb-0"><a href="#" class="btn btn-primary">Our Books</a> <a href="Listbook.jsp" class="btn btn-white">Learn More</a></p>
    </div>
</div>
</div>
</div>
...
<div class="col-md-12 text-center mt-5">
    <a href="Listbook.jsp" class="btn btn-secondary">See All BOOKS</a>
</div>
</div>
</div>
</section>
