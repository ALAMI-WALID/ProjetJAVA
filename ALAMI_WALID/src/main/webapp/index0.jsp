  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        ...
        <p class="mb-0"><a href="#" class="btn btn-primary">Our Books</a> <a href="login.jsp" class="btn btn-white">Learn More</a></p>
    </div>
</div>
</div>
</div>
...
<div class="col-md-12 text-center mt-5">
    <a href="login.jsp" class="btn btn-secondary">See All BOOKS</a>
</div>
</div>
</div>
</section>
