 ...
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item"><a href="Listbook.jsp" class="nav-link">List Book</a></li>
     </ul>
 </div>
</div>
</nav>
         ...
         <div class="col-md-5 order-md-last">
          ...
          <%
				if (request.getParameter("res") != null) {
					if (request.getParameter("res").equals("suc")){
				%>
		 <li class="list-group-item list-group-item-danger">l'operation bien effectue</li>
				<%
				}
				}
				%>
              <h3 class="mb-4">ADD BOOK NOW!!</h3>
              <form action="ADDbook" class="signup-form" method="post">
                 <div class="form-group">
                    <label class="label" for="name">Name Book</label>
                    <input type="text" name="name" class="form-control" placeholder="Smart world" required>
                </div>
                <div class="form-group">
                    <label class="label" for="name">Full Author Name</label>
                    <input type="text" name="fname" class="form-control" placeholder="Steven mark" required>
                </div>
                 <div class="form-group">
                    <label class="label" for="name">Id Book</label>
                    <input type="text" name="id" class="form-control" placeholder="552" required>
                </div>
                <div class="form-group">
                    <label class="label" for="email">Book Category</label>
                    <input type="text" name="category" class="form-control" placeholder="Science" required>
                </div>
                <div class="form-group">
                 <label class="label" for="password">Date editing</label>
                 <input id="password-field" type="date" name="date" class="form-control" placeholder="" required>
             </div>
